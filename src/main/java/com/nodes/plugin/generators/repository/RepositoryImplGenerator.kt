...
class RepositoryImplGenerator : BaseGenerator<Repository>() {
    ...
    override var getTemplate = TemplateMap.REPOSITORY_IMPL
    ...
    override fun additionalProperties(modelObject: Repository, properties: Properties?): Properties? {
        return Properties().apply {
            ...
            setProperty(
                TemplateProperties.LOCAL_DS_NAME,
                modelObject.name + if (modelObject.roomRepository) "Dao" else "LocalDataSource"
            )
